...
\begin{center}
    \geogebra{cdzqzkgm}{100}{100}%{950}{800}
\end{center}
...
\begin{hint}
    You can accomplish this by changing one of the diagonal entries only
\end{hint}
\begin{exercise}
...
\begin{exercise}
Try changing the entries in the matrix but make sure that the image has area 4.  Can you spot a general property of the matrix that ensures that the area of the image is twice the area of the original rectangle?
\end{exercise}
\end{exercise}
\end{exercise}
\end{exercise}
